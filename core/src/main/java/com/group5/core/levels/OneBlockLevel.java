...
public class OneBlockLevel extends GameSlice{
   ...
   */
  public OneBlockLevel(final String slice, final float floorNumber, final float noGapFloorNumber, final float obstaclesNumber,
