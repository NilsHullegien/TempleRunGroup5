...
public class PlayerTest {
    ...
    public void equalsTest() {
        ...
        Player p1 = new Player(new Vector2(0, 0), new Vector2(0, 0));
        assertTrue(p1.equals(p1));

        //a player is the same as another player with the same properties
        Player p2 = new Player(new Vector2(0, 0), new Vector2(0, 0));
        assertTrue(p1.equals(p2));

        //a player is not the same as a player with different player
        Player p3 = new Player(new Vector2(1, 0), new Vector2(0, 0));
        assertFalse(p1.equals(p3));
        Player p4 = new Player(new Vector2(0, 1), new Vector2(0, 0));
